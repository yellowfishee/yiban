    ...
    <View className="agreement-page">
      ...
      <View className="agreement-page__section">
        ...
        <Text className="agreement-page__section-content">
          ...
          （2）用户资料：您主动填写的昵称和头像，用于个性化展示；{'\n'}
          （3）手机号码：用于账号登录和身份验证，我们仅在您主动授权后收集；{'\n'}
          （4）使用记录：您的打卡记录、卦象记录、收藏内容等，用于提供服务功能；{'\n'}
          （5）设备信息：设备型号、操作系统版本等，用于优化服务体验。{'\n'}
          2.2 信息收集方式：{'\n'}
          我们通过您主动授权和自动收集的方式获取上述信息。{'\n'}
          2.3 手机号码收集说明：{'\n'}
          （1）收集目的：用于账号登录、身份验证、安全保护；{'\n'}
          （2）收集方式：通过微信小程序手机号快速验证组件，您需要主动点击授权；{'\n'}
          （3）使用范围：仅用于账号相关功能，不会用于营销推广；{'\n'}
          （4）存储方式：加密存储，不会向第三方披露。
        </Text>
      </View>
